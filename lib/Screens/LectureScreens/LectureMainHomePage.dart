...
import 'package:minglerapp/Screens/LectureScreens/LectureAttendenceDetails.dart';
import 'package:minglerapp/Screens/LectureScreens/LectureMainSubject.dart';
import 'package:minglerapp/Screens/Unreads_Classes_scheduled.dart';

class LectureMainHomePage extends StatelessWidget {
  @override
                              ...
                              GestureDetector(
                                onTap: () {
                                  ...
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (build) => LectureMainSubject(),
                                    ),
                                  );
                                },
                                child: unreads(
